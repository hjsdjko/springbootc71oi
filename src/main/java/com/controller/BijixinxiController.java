...
public class BijixinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,BijixinxiEntity bijixinxi,
		...
		if(tableName.equals("yonghu")) {
			bijixinxi.setZhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<BijixinxiEntity> wrapper = new EntityWrapper<BijixinxiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = bijixinxiService.selectCount(wrapper);
